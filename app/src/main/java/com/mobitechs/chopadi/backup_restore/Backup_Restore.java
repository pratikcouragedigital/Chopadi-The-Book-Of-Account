package com.mobitechs.chopadi.backup_restore;
    ...
    public void importDB(Activity activity) {
        try {
            ...
            if (Environment.MEDIA_MOUNTED.equals(state)) {
                String currentDBPath = "//data/com.mobitechs.chopadi/databases/Chopadi";
                String backupDBPath = "/Chopadi/backup/ChopadiBackup";
...
//            Toast.makeText(activity, a+"", Toast.LENGTH_SHORT).show();
            ...
            File dbFile = new File(Environment.getDataDirectory() + "/data/com.mobitechs.chopadi/databases/Chopadi");
